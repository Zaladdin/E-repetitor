...
export interface AssignTestInput {
  ...
  timeLimitMin?: number; dueAt?: string; answerPolicy: AnswerPolicy;
}
export interface TestAttemptSummary {
  ...
  passPoints?: number; passed?: boolean;
}
export interface TestAssignment {
  ...
  answerPolicy: AnswerPolicy; createdAt: string; isLate: boolean; attempts: TestAttemptSummary[];
}
...
export interface TestAttempt extends TestAttemptSummary {
  ...
  studentName: string; subjectName: string; teacherName: string; answerPolicy: AnswerPolicy;
